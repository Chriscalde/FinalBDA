...
exports.create = (req, res) => {
    ...
    const member = new Member({
        ...
        "player.offense_stats.yards_pass": req.body.yards_pass || 0,
        "player.offense_stats.yards_run": req.body.yards_run || 0,
        "player.offense_stats.yards_received": req.body.yards_received || 0,
